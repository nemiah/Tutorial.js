 ...
 * 	2012-06-07
 */
class VideoGUIKeyboardActions extends VideoGUIDesignActions {
	...
	public function getHtml($entry, $attributes, $parsers) {
		...
		$firstFlag = true;
		$html = '<div id="VideoGUIStep_' . $this->getTestStepId() . '" class="punit_qtip punit_draggable ui-state-default" style="display: inline-block; margin: 5px; border: solid 1px #336699; border-radius: 4px; background-color: #6699ff; width: 116px; height: 80px;">';
