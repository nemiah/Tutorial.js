 ...
 * 	2012-06-07
 */
class VideoGUIMouseActions extends VideoGUIDesignActions {
	...
	public function getHtml($entry, $attributes, $parsers) {
		...
		$firstFlag = true;
		$html = '<div id="VideoGUIStep_' . $this->getTestStepId() . '" class="punit_qtip punit_draggable ui-state-default" style="display: inline-block; margin: 5px; border: solid 1px #003300; border-radius: 4px; background-color: #99cc99; width: 116px; height: 80px;">';
		...
		foreach ($attributes as $attribute) {
			...
			if ($attribute == "TestStepType" && $entry->A($attribute) == "openTab") {
				$html = '<br>' . $html;
			}
		}
